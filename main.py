...
class Snake(tk.Canvas):
    ...
    def load_img(self):
        try:
            self.snake_body_image = Image.open("./img/snake.png")
            self.snake_body = ImageTk.PhotoImage(self.snake_body_image)

            self.food_image = Image.open("./img/food.png")
    ...
    def create_objects(self):
        self.create_text(35, 12, text="Score: "+str(self.score),
    ...
    def check_collisions(self):
        ...
        return (
            headX in (0, 600)
            or headY in (20, 620)
            or (headX, headY) in self.snake_positions[1:]
        )
